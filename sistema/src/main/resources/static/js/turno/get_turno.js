    ...
    (function(){
      ...
      //recorremos la colección de turnos del JSON
         for(turno of data){
            ...
            let strUsuario = turno.usuario.nombre.toUpperCase() + " " + turno.usuario.apellido.toUpperCase() + " (" + turno.usuario.id + ")"
            let strPrestador = turno.prestador.nombre.toUpperCase() + " " + turno.prestador.apellido.toUpperCase() + " (" + turno.prestador.id + ")"

            turnoRow.innerHTML = '<td>' + updateButton + '</td>' +
                    '<td class=\"td_usuario\">' + strUsuario + '</td>' +
                    '<td class=\"td_prestador\">' + strPrestador + '</td>' +
